    ...
    <nav className="nav__dashboard-container">
      <ul className="nav__dashboard-list">
        <div className="nav__dashboard-top">
          <a className="button__primary nav__dashboard-button">overzicht</a>
          <a className="button__secondary nav__dashboard-button">nieuw spel</a>
        </div>
          <a onClick={(e) => signOut()} className="button__cancel nav__dashboard-button">afmelden</a>
      </ul>
    </nav>
  );
};
